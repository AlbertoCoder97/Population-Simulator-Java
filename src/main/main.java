...
public class main {
	...
	public static final int GRANDEZZA_POPOLAZIONE_INIZIALE = 50; //Questo numero indica per quante volte aggiungerà alla popolazione iniziale ogni tipo di essere umano
	
	public static final int TOLLERANZA_PERC = 10; //Tolleranza nella differenza della percentuale dei Morigerati e Prudenti
	public static final int GENERAZIONI_CHECK = 5; //Numero di generazioni da controllare
	public static final int GENERAZIONI_MASSIME = 20;
